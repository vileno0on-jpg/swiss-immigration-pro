...
const SEARCH_INDEX: SearchResult[] = [
  ...
  { id: '13', title: 'Eligibility Quiz', description: 'Check your permit eligibility', url: '/quiz', category: 'tool', icon: Calculator, keywords: ['quiz', 'eligibility', 'qualify', 'eligible', 'assessment', 'check'] },
