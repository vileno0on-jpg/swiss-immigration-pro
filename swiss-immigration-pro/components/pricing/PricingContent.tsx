    ...
    <div className={`min-h-screen ${layer === 'default' ? 'bg-white dark:bg-gray-950' : 'bg-white dark:bg-gray-950'} font-sans transition-colors duration-300`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight">
              Invest in Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Future</span>
            </h1>
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <span className={`text-sm font-medium transition-colors ${billingCycle === 'annual' ? 'text-white' : 'text-slate-400'}`}>
                Annual <span className="text-green-400 text-xs ml-1 font-bold">-20%</span>
              </span>
            </div>
          </motion.div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-20 pb-24">
        ...
        <div className="mt-24 py-12 border-t border-slate-200">
          <p className="text-center text-slate-400 font-semibold uppercase tracking-widest text-sm mb-8">Trusted by professionals from</p>
          <div className="flex flex-wrap justify-center gap-12 opacity-50 grayscale hover:opacity-100 transition-opacity duration-500">
            ...
            {['Google', 'Novartis', 'Roche', 'UBS', 'CERN'].map((logo) => (
              <span key={logo} className="text-2xl font-bold text-slate-800">{logo}</span>
            ))}
          </div>
        </div>
      </div>
