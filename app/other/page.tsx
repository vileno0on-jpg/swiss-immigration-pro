...
export default function OtherPage() {
  ...
  const heroStats = [
    { value: 'Lottery', label: 'Swiss Lottery', description: 'Annual visa lottery' },
    { value: 'Quota', label: 'Work Permits', description: 'Limited availability' },
    { value: 'Student', label: 'Student Visa', description: 'Education pathway' },
    { value: 'Family', label: 'Family Reunification', description: 'Join family members' }
  ]
    ...
    <div className="bg-white dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Link href="/other/visas" className="card p-6 hover:shadow-lg transition-shadow text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Work, student, family</p>
            </Link>
            ...
            <Link href="/other/resources" className="card p-6 hover:shadow-lg transition-shadow text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">International guides</p>
            </Link>
          </div>
        </div>
      </section>
      ...
      <div className="text-center py-12">
        <Link href="/other/visas" className="btn-primary">
          Explore International Advantages
        </Link>
      </div>
    </div>
  )
