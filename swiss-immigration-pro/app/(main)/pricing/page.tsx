      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-blue-600 font-semibold">
            Save CHF 5,000-15,000 vs immigration consultants • Cancel anytime
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {Object.values(PRICING_PACKS).map((pack: PricingPack, idx) => (
            <motion.div
              ...
              className={`card p-8 relative overflow-visible ${
                pack.id === 'advanced' ? 'ring-2 ring-blue-600 scale-105 shadow-2xl md:scale-105 sm:scale-100' : ''
              }`}
            >
              {pack.id === 'advanced' && (
                <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white text-sm font-bold px-5 py-1.5 rounded-full inline-flex items-center shadow-lg">
              ...
              <div className="text-center mb-6">
                ...
                <div className="mb-4">
                  <span className="text-5xl font-bold text-gray-900">
                    CHF {typeof pack.price === 'number' ? pack.price.toFixed(0) : pack.price}
                  </span>
                  {pack.price > 0 && (
                ...
                {pack.price > 0 && pack.id !== 'citizenship' && (
                ...
                {pack.id === 'citizenship' && (
                  <p className="text-sm text-blue-600 font-medium">
                    Lifetime access • Save 20% annually
                  </p>
                )}
              </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-center py-4 px-4 text-gray-600">Free</th>
                  <th className="text-center py-4 px-4 text-gray-600">Immigration</th>
                  <th className="text-center py-4 px-4 text-gray-600">Advanced</th>
                  <th className="text-center py-4 px-4 text-gray-600">Citizenship Pro</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {[
                  ...
                  <tr key={idx} className="hover:bg-gray-50">
                    ...
                    <td className="py-4 px-4 text-center text-gray-600">{row.immigration}</td>
                    <td className="py-4 px-4 text-center text-gray-600">{row.advanced}</td>
                    <td className="py-4 px-4 text-center text-gray-600">{row.citizenship}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: 'Traditional Swiss immigration consultants charge CHF 5,000-15,000 for full service. Our Advanced Pack at CHF 49/month provides comprehensive guidance, unlimited AI support, and all resources at less than 1% of consultant fees. Over 12 months, you save CHF 4,400+ compared to a single consultant session.',
              },
              {
              ...
              },
              {
                ...
                a: 'Yes! Annual subscriptions save 20% and include priority support. Immigration Pack: CHF 182/year (save CHF 46), Advanced Pack: CHF 470/year (save CHF 118), Citizenship Pro: CHF 1,429/year (save CHF 359).',
              },
            ].map((faq, idx) => (
              <motion.div
                key={idx}
