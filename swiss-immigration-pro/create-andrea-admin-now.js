...
const ADMIN_EMAIL = 'andrea.vonflue@gmail.com';
const ADMIN_PASSWORD = 'Andreavf002';
const ADMIN_NAME = 'Andrea Von Flue';

// Database configuration - try to get from environment or use defaults
const pool = new Pool({
  host: process.env.DB_HOST || 'localhost',
  port: parseInt(process.env.DB_PORT || '5432'),
  database: process.env.DB_NAME || 'swiss_immigration',
  user: process.env.DB_USER || 'postgres',
  password: process.env.DB_PASSWORD || 'Terminateur08a21aaaqqqeee',
});
